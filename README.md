...
#### 1. [SMA TARUNA MANDARA](https://www.smatarunamandara.sch.id/) | Singaraja, Bali 2022-2025
...
- KARANG TARUNA DESA PATEMON

## 🌟 Keahlian Saat Ini

- *Bahasa Pemrograman*: HTML, JavaScript, CSS, C++, Python (Basic)
...
- *X/Twitter*: [x.com/AndiPrata_](https://x.com/AndiPrata_)
